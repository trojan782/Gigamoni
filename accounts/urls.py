...
urlpatterns = [
    ...
    path('register/<int:pk>/company2/', CompanyStage2View.as_view(), name='company_register2'),
    path('register/<int:pk>/company3/', CompanyStage3View.as_view(), name='company_register3'),
